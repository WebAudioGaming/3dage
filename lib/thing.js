...
var _ = {
  ...
  createSoundStream: function createSoundStream () {
    return Rx.Observable.from(this.reacts)
...
function Thing () {
  var definition = [].prototype.splice(arguments).reduce(_.mixInReducer, secretDefaults)
  var proto = Object.assign(Object.create(_.ThingPrototype), definition.functions, {
    // TODO: make defaults readonly
    defaults: R.cloneDeep(definition.defaults)
  })
  return {
    spawn: function spawn (world, attributes) {
      ...
      instance.sound = _.createSoundStream.call(this)
